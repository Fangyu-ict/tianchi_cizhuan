...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True),
        ...
        keep_ratio=True),
    dict(type='RandomCrop', crop_size=(1700,1300)),
...
log_level = 'INFO'
# work_dir = '../data/work_dirs/cascade_rcnn_r50_fpn_0117_a1'
work_dir = '../data/work_dirs/cascade_rcnn_x101_fpn_0124_overfit'
load_from = '../data/pretrained/concatenate_coco_pretrained_cascade_rcnn_x101_32x4d_fpn_2x_20181218-28f73c4c.pth'
resume_from = None
workflow = [('train', 1)]
