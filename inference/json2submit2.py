...
# isfilter = True
test_json_raw = json.load(open("../data/cizhuan/annotations/china_testa_round2.json", "r"))
test_json = json.load(open('../data/results_20.bbox.json', "r"))
...
with open('../data/results_deep.json', 'w') as fp:
