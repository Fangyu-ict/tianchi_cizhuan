...
# isfilter = True
test_json_raw = json.load(open("../data/cizhuan/annotations/china_testb_round2.json", "r"))
test_json = json.load(open('../submit/testB/results_alldata_multi_b.bbox.json', "r"))
...
with open('../submit/testB/test.json', 'w') as fp:
