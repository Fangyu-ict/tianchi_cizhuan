...
def merge_json():
    ...
    json_best_path = '../submit/result_dcn_0127_nofrozen.json'
    json_data_path = '../submit/result_dcn_0127_nofrozen.json'#'../submit/testB/results_alldata_multi_b.json'
    ...
    for name in img_list:
        ...
        for kind in range(1, num_classes+1, 1):
