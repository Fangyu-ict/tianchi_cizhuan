...
class China2COCO:
    ...
    def to_coco(self, anno_file, img_dir):
        ...
        anno_result = pd.read_csv(open(anno_file,"r"))
...
'''转换有瑕疵的样本为coco格式'''
img_dir = '../data/data2/2_images/'
anno_dir= '../data/data2/annotations/train_converted.json'
china2coco = China2COCO()
train_instance = china2coco.to_coco(anno_dir, img_dir)
china2coco.save_coco_json(train_instance, "../data/data2/annotations/train_annos_coco_0608.json")
